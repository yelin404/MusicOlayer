...
public class SingerUtils {
        ...
        public static List<SingerBean> getSingerList() {
                List<SingerBean> list = new ArrayList<>();
                for (int i = 0;i < singerName.length;i++) {
                        SingerBean singerBean = new SingerBean(singerName[i],singerSex[i],singerWork[i],singerSuccess[i],singerImage[i] );
                        list.add(singerBean);
                }
                return list;
        }
